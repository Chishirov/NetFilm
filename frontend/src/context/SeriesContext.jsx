...
export const SeriesProvider = ({ children }) => {
  ...
  return (
    <SeriesContext.Provider value={{ aring, setAring,onTv,setOnTv,popular,setPopular,rated,setRated, seriesInfo, setSeriesInfo,fetchDataAring,seriesId,setSeriesId }}>
      {children}
